...
class TextNormalization:
     def __init__(self, string_lower,
                    remove_emojis,
                    remove_hashtags,
                    remove_emails,
                    remove_url,
     ...
     def delete_special_character_(self,text):
     ...
     def delete_longest_than_(self,text):
          "Delete All Words That Longest Than The Longest Word In Englis"
     ...
     def delete_unicode_characters_(self,text):
          "Delete Unicode Char"
     ...
     def delete_non_english(self,text):
          "Delete Non English Word And Char"
     ...
     def normalization(self, text):
          ...
          if self.remove_special_character == True:
               text = self.delete_special_character_(text)
